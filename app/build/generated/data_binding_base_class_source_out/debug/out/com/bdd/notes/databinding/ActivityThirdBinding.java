...
public final class ActivityThirdBinding implements ViewBinding {
  ...
  private ActivityThirdBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatButton start) {
  ...
  public static ActivityThirdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityThirdBinding((ConstraintLayout) rootView, start);
    }
